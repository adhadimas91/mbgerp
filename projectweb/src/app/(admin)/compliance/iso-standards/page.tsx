...
export default function IsoStandardsPage() {
  return (
    <ModulePageLayout
      ...
      badgeText="ISO 22000 • 9001 • 27001"
      pageTitle="Matriks Kepatuhan Standar ISO & Sertifikasi MBG"
      description="Dashboard terpadu pemenuhan standar keamanan pangan (HACCP/ISO 22000), SOP mutu operasional (ISO 9001), dan keamanan data informasi (ISO 27001)."
    />
  );
}
