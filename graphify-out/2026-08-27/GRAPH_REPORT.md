...
## Corpus Check
- 376 files · ~842,929 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1438 nodes · 2324 edges · 133 communities (94 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3335e17e`
...
- overrides
- projectweb/src/app/(admin)/layout.tsx
...
- AuditLogViewer.tsx
- projectweb/src/app/(admin)/(ui-elements)/buttons/page.tsx
- apexcharts
...
Cohesion: 0.31
Nodes (6): ThemeTogglerTwo(), Theme, ThemeContext, ThemeContextType, ThemeProvider(), useTheme()
...
### Community 11 - "projectweb/src/components/common/ComponentCard.tsx"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (16): metadata, DefaultInputs(), DropzoneComponent(), FileInputExample(), InputStates(), RadioButtons(), TextAreaInput(), ToggleSwitch() (+8 more)
...
Cohesion: 0.15
Nodes (13): dependencies, flatpickr, @fullcalendar/daygrid, @fullcalendar/timegrid, react, react-dnd-html5-backend, @tailwindcss/forms, flatpickr (+5 more)
...
### Community 49 - "projectweb/src/components/auth/SignInForm.tsx"
Cohesion: 0.27
...
### Community 54 - "projectweb/src/components/ui/button/Button.tsx"
Cohesion: 0.15
Nodes (17): CalendarEvent, StockMovementModalProps, CreateShipmentModal(), CreateShipmentModalProps, Shipment, LiveTrackingModal(), LiveTrackingModalProps, PodSubmissionModalProps (+9 more)
...
Cohesion: 0.25
Nodes (7): metadata, PodDetailModal(), PodDetailModalProps, PodRecord, PodSubmissionModal(), initialPods, ProofOfDeliveryViewer()
...
Cohesion: 0.13
Nodes (15): metadata, initialLines, initialOrganoleptic, KitchenOverviewDashboard(), KitchenRequisitionItem, KitchenRequisitionModal(), KitchenRequisitionModalProps, KitchenSpkPrintModal() (+7 more)
...
### Community 69 - "uiweb/src/app/(admin)/(others-pages)/(chart)/bar-chart/page.tsx"
Cohesion: 0.40
Nodes (3): metadata, BarChartOne(), ReactApexChart

### Community 70 - "FinanceOverviewDashboard.tsx"
Cohesion: 0.18
Nodes (9): metadata, FinanceOverviewDashboard(), ReactApexChart, RECENT_TRANSACTIONS, REGIONAL_BUDGETS, RegionalData, FinancialReportLraPrintModal(), FinancialSimulationModal() (+1 more)
...
Cohesion: 0.24
Nodes (7): BrandLogo(), BrandLogoProps, FinancialReportLraPrintModalProps, governanceNavItems, NavItem, operationalNavItems, SidebarWidget()
...
### Community 76 - "uiweb/src/components/auth/SignInForm.tsx"
Cohesion: 0.27
Nodes (5): metadata, SignInForm(), CheckboxComponents(), Checkbox(), CheckboxProps
...
### Community 82 - "projectweb/package.json"
Cohesion: 0.22
Nodes (8): name, private, scripts, build, dev, lint, start, version

### Community 92 - "projectweb/src/layout/AppHeader.tsx"
Cohesion: 0.25
Nodes (3): ThemeToggleButton(), NotificationDropdown(), UserDropdown()
...
### Community 95 - "projectweb/src/app/(admin)/layout.tsx"
Cohesion: 0.57
Nodes (5): AdminLayout(), useSidebar(), AppHeader(), AppSidebar(), Backdrop()

### Community 96 - "MenuPlannerCalendar.tsx"
Cohesion: 0.33
Nodes (4): metadata, DailyMenuPlan, MenuPlannerCalendar(), mockMenuPlans

### Community 98 - "projectweb/src/context/SidebarContext.tsx"
Cohesion: 0.33
Nodes (4): outfit, SidebarContext, SidebarContextType, SidebarProvider()

### Community 99 - "uiweb/src/app/(admin)/(others-pages)/(chart)/line-chart/page.tsx"
Cohesion: 0.40
Nodes (3): metadata, LineChartOne(), ReactApexChart

### Community 100 - "projectweb/src/components/form/Label.tsx"
Cohesion: 0.13
Nodes (16): metadata, metadata, SignUpForm(), DatePicker(), PropsType, InputGroup(), CountryCode, PhoneInput() (+8 more)
...
## Knowledge Gaps
- **517 isolated node(s):** `extends`, `next/core-web-vitals`, `eslintConfig`, `jsvectormap`, `nextConfig` (+512 more)
...
- **Why does `ModulePageLayout()` connect `ModulePageLayout.tsx` to `verification/page.tsx`, `projectweb/src/app/(admin)/page.tsx`, `AssetRegistryTable.tsx`, `PaymentManagement.tsx`, `ExpenditureManagement.tsx`, `BudgetManagement.tsx`, `HygieneInspectionsAudit.tsx`, `inventory/alerts/page.tsx`, `DistributionPointsTable.tsx`, `EmployeeRegistryTable.tsx`, `ProofOfDeliveryViewer.tsx`, `UserManagementTable.tsx`, `KitchenOverviewDashboard.tsx`, `KitchenFinancialDashboard.tsx`, `FinanceOverviewDashboard.tsx`, `ColdChainTelemetry.tsx`, `reports/page.tsx`, `cost-analysis/page.tsx`, `RecipeBuilder.tsx`, `catalog/page.tsx`, `SupplierTable.tsx`, `performance/page.tsx`, `MenuPlannerCalendar.tsx`, `IncidentReportManagement.tsx`, `IsoComplianceMatrix.tsx`, `AuditLogViewer.tsx`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `PageBreadcrumb()` connect `projectweb/src/components/common/PageBreadCrumb.tsx` to `projectweb/src/app/(admin)/(others-pages)/(chart)/line-chart/page.tsx`, `projectweb/src/app/(admin)/(ui-elements)/buttons/page.tsx`, `projectweb/src/components/common/ComponentCard.tsx`, `projectweb/src/app/(admin)/(others-pages)/(forms)/form-elements/page.tsx`, `projectweb/src/app/(admin)/(ui-elements)/avatars/page.tsx`, `projectweb/src/app/(admin)/(ui-elements)/images/page.tsx`, `projectweb/src/app/(admin)/(ui-elements)/videos/page.tsx`, `projectweb/src/app/(admin)/(others-pages)/(chart)/bar-chart/page.tsx`, `projectweb/src/app/(admin)/(ui-elements)/alerts/page.tsx`, `ModulePageLayout.tsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ComponentCard()` connect `uiweb/src/components/common/ComponentCard.tsx` to `uiweb/src/components/form/Label.tsx`, `uiweb/src/app/(admin)/(others-pages)/(chart)/line-chart/page.tsx`, `uiweb/src/app/(admin)/(ui-elements)/avatars/page.tsx`, `uiweb/src/app/(admin)/(ui-elements)/alerts/page.tsx`, `uiweb/src/app/(admin)/(others-pages)/(chart)/bar-chart/page.tsx`, `uiweb/src/components/common/PageBreadCrumb.tsx`, `useModal`, `uiweb/src/components/auth/SignInForm.tsx`, `uiweb/src/components/form/form-elements/SelectInputs.tsx`, `uiweb/src/app/(admin)/(ui-elements)/images/page.tsx`, `uiweb/src/app/(admin)/(ui-elements)/videos/page.tsx`?**
