...
## Corpus Check
- 295 files · ~735,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1141 nodes · 1823 edges · 93 communities (71 shown, 22 thin omitted)
...
Cohesion: 0.20
Nodes (15): metadata, metadata, DefaultModal(), FormInModal(), FullScreenModal(), ModalBasedAlerts(), VerticallyCenteredModal(), Button() (+7 more)
...
Cohesion: 0.08
Nodes (16): metadata, metadata, metadata, metadata, metadata, Calendar(), CalendarEvent, LineChartOne() (+8 more)
...
Cohesion: 0.15
Nodes (12): metadata, PodDetailModal(), PodDetailModalProps, PodRecord, PodSubmissionModal(), initialPods, ProofOfDeliveryViewer(), Badge() (+4 more)

### Community 11 - "ShipmentManagement.tsx"
Cohesion: 0.22
...
### Community 14 - "projectweb/src/components/ui/button/Button.tsx"
Cohesion: 0.15
Nodes (19): metadata, Calendar(), CalendarEvent, DefaultModal(), FormInModal(), FullScreenModal(), ModalBasedAlerts(), VerticallyCenteredModal() (+11 more)
...
### Community 54 - "projectweb/src/components/form/form-elements/InputGroup.tsx"
Cohesion: 0.40
...
## Knowledge Gaps
- **442 isolated node(s):** `extends`, `next/core-web-vitals`, `eslintConfig`, `jsvectormap`, `nextConfig` (+437 more)
